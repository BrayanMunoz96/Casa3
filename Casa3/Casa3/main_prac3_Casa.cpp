...
//Práctica No. 3 Tarea para Casa
//Este programa funciona llamando la función prisma() la cual recibe 2 parámetros:
//								int largo  e  int ango
//Medidas que se deseen para la figura que se mostrará
...
//Propuestas de variables que recibe la función prisma()
int largo = 0;
int ancho = 0;
...
void prisma(int largo, int ancho)
{ 
	int largoF = 0;
	int anchoF = 0;
	...
	GLfloat vertice [8][3] = { //Todos los puntos para representar un prisma
				{largoF ,-anchoF, 0.5},    //Coordenadas Vértice 0 V0 
				{-largoF ,-anchoF, 0.5},    //Coordenadas Vértice 1 V1
				{-largoF ,-anchoF, -0.5},    //Coordenadas Vértice 2 V2
				{largoF ,-anchoF, -0.5},    //Coordenadas Vértice 3 V3
				{largoF ,anchoF, 0.5},    //Coordenadas Vértice 4 V4
				{largoF ,anchoF, -0.5},    //Coordenadas Vértice 5 V5
				{-largoF ,anchoF, -0.5},    //Coordenadas Vértice 6 V6
				{-largoF ,anchoF, 0.5},    //Coordenadas Vértice 7 V7 
				};
